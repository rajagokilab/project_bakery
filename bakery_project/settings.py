...
SECRET_KEY = 'django-insecure-py9xs0qa^o0(!bcu526ycv3-b$qmkwk%w$+yg*$$)m+5*byzqh'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'bakery' / 'static']  # your app static folder
...
# Optional: redirect users here after login
LOGIN_REDIRECT_URL = '/'  # you can change to any page, e.g., home or dashboard
